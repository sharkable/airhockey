...
Puck::Puck(SharkEngine &shark_engine, Rink &rink) : RoundThing(shark_engine, "puck"), rink_(rink) {
  radius_ = kPuckRadius;
  mass_ = kPuckMass;
  ...
  two_puck_hit_sound_ = shark_engine.sound()->GetSound("sounds/puck_puck_hit.wav");
  paddle_hit_sound_ = shark_engine.sound()->GetSound("sounds/paddle_hit.wav");
  puck_rink_bounce_sound_ = shark_engine.sound()->GetSound("sounds/puck_rink_bounce.wav");
}
