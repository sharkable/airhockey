...
RinkView::RinkView(SharkEngine &shark_engine) {
  Sprite background_sprite(shark_engine, "rink_bg");
  SimpleItem *background = new SimpleItem(background_sprite, shark_engine.position("rink_bg"));
